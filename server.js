...
bot.command("start", function (msg, reply, next) {
  if (msg.args() && msg.context.id === owner && Object.hasOwnProperty.call(tokens, msg.args())) {
    ...
    reply.html("Welcome! Use /run to execute commands, and reply to my messages to send input. /help for more info. To view information about the bot, enter /about");
  }
});

bot.command("about", function (msg, reply, next) {
  reply.html("Information about the bot\nAuthor: D1xus#0442 \nLanguage: Node.js\nGitHub: soon...");
})
...
bot.command("help", function (msg, reply, next) {
  reply.html(
    ...
    "‣ Use /about to get information about the bot\n" +
